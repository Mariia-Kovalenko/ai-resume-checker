...
export default function ResumeUploader({
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm p-8 max-w-xl mx-auto mt-8">
            ...
            >
                ...
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-[var(--color-grey)] font-medium mt-4">
                        Drag & drop or click to upload files
                    </span>
                </div>
            </div>
            <div className="flex w-full justify-between text-sm text-gray-400 mt-2">
            ...
            {file && (
                <div className="flex items-center gap-4 border border-[var(--color-light-purple)] bg-[var(--background)] rounded-md px-4 py-3 mt-4">
                    <div className="w-[46px] h-[46px] border-1 rounded-md border-[var(--color-light-purple)] bg-white flex items-center justify-center">{getFileIcon(file.type)}</div>
            ...
            <div className="mt-8">
                ...
                <div className="relative">
                    <textarea
                        id="job-title"
                        className="w-full bg-[var(--background)] rounded-md border-1 border-gray-200 p-4 text-base resize-none transition-all duration-200 outline-[transparent] outline-2 focus:outline-[var(--color-purple)]"
